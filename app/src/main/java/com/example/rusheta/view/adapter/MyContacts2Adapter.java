...
public class MyContacts2Adapter extends RecyclerView.Adapter {
    ...
    private SignalProtocolKeyGen signalProtocolKeyGen;

    public MyContacts2Adapter(Context context, List<Contacts2> contactList, SignalProtocolKeyGen signalProtocolKeyGen) {
